...
namespace Unity.XR.XREAL
{
    ...
    public class XREALCaptureBehaviour : CaptureBehaviourBase
    {
        ...
        public void DoAsyn(XREALPhotoCapture.OnCapturedToMemoryCallback oncapturedcallback)
        {
            ...
            captureTask.Height = cameraParam.captureSide == CaptureSide.Both ? (int)(0.5 * cameraParam.cameraResolutionHeight) : cameraParam.cameraResolutionHeight;
            ...
            captureTask.OnReceive += (task, data) =>
            {
                ...
                {
                    var result = new XREALPhotoCapture.PhotoCaptureResult();
                    result.resultType = XREALPhotoCapture.CaptureResultType.Success;
