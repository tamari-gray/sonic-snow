...
namespace Unity.XR.XREAL
{
    public class AudioFilterStream : IDisposable
    {
        ...
        protected void Write(byte[] bytesData)
        {
            ...
            // Debug.LogWarning("[AudioFilterStream] Write: data={0}, writeIdx={1}", bytesData.Length, m_WriteIndex);
        }
        ...
        public bool Flush(ref byte[] outBytesData)
        {
            ...
            {
                // Debug.LogWarning("[AudioFilterStream] Flush fail: readIdx={0}, writeIdx={1}", m_ReadIndex, m_WriteIndex);
                return false;
            }
            ...
            // Debug.LogWarning("[AudioFilterStream] Flush: data={0}, readIdx={1}, writeIdx={2}", outBytesData.Length, m_ReadIndex, m_WriteIndex);
