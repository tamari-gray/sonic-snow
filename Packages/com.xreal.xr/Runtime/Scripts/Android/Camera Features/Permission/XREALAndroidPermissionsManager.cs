...
namespace Unity.XR.XREAL
{
    ...
    public class XREALAndroidPermissionsManager : AndroidJavaProxy, IAndroidPermissionsCheck
    {
        /// <summary> The instance. </summary>
        private static XREALAndroidPermissionsManager _instance;
        ...
        public XREALAndroidPermissionsManager() : base(
        ...
        {
            if (XREALAndroidPermissionsManager.IsPermissionGranted(permissionName))
            {
        ...
        public static XREALAndroidPermissionsManager GetInstance()
        {
            if (_instance == null)
            {
                _instance = new XREALAndroidPermissionsManager();
            }
